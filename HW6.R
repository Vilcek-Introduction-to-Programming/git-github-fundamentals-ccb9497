#What I learned:
#How to navigate GitHub! I learned some of the jargon (repositories, committing/pushing, pull requests, etc) as well as learning that GitHub is a very efficient way to collaborate on code
#and allow for people to work on the same scripts in parallel, with the ease and benefit of having an online trail to see what new changes were put into effect with every step.
...
#GitHub before the last class so this is all very new! So I think there are not so many things I am confused about, moreso I need some time to really get used to the workflow.
